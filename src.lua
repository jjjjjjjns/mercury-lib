...
function Library:create(options)
	...
	creditsTab:credit{Name = "Blatant", Description = "Main Scripter", Discord = "Blatant#5145"}
	creditsTab:credit{Name = "Viewport", Description = "Another Scripter", Discord = "Viewport#2153"}
